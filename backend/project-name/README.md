...
2D Multiplayer Game Backend - WebSocket server for real-time player movement and chat.
...
CORS is enabled for all origins (`*`) for development. Update in `game.gateway.ts` if needed.
